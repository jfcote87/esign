...
// https://developers.docusign.com/docs/esign-api/v2/reference/Users
// Usage example:
//
//   import (
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/contacts/create
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/contacts/delete
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/contacts/deletelist
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/contacts/get
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/contacts/update
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/usercustomsettings/delete
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/usercustomsettings/list
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/usercustomsettings/update
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/userprofiles/get
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/userprofiles/update
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/usersignatures/create
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/usersignatures/delete
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/usersignatures/deleteimage
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/usersignatures/get
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/usersignatures/getimage
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/usersignatures/list
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/usersignatures/update
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/usersignatures/updateimage
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/usersignatures/updatelist
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/users/create
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/users/delete
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/users/deleteprofileimage
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/users/get
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/users/getprofileimage
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/users/getsettings
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/users/list
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/users/update
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/users/updatelist
// 
...
// If media is an io.ReadCloser, Do() will close media.
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/users/updateprofileimage
// 
...
// 
// https://developers.docusign.com/docs/esign-api/v2/reference/users/users/updatesettings
// 
