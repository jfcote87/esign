...
//   import (
//       "{{.Directory}}"
//       "{{.Directory}}/{{$verPrefix}}/{{.Package}}"{{if .ModelPackage}}
//       "{{.Directory}}/{{.PackagePath}}{{.ModelPackage}}"{{end}}
//   ) 
//   ...
...
{{$defMap := .DefMap}}{{$fldOverrides := .FldOverrides}}{{if .IsPackage}}// Package model provides definitions for all input
...
package model // import "github.com/jfcote87/esign/{{.VersionID}}/model"{{else}}
